            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        ...
                        <form class="mb-0" method="post" action="updateUserProfile.html">
                            <p style="font-size:16px; color:red" align="center"></p>
                            <div class="form-box">
                                <h4 class="form--title">Personal Details</h4>
                                <div class="form-group">
                                    <label for="full-name">Full Name</label>
                                    <input type="text" class="form-control" name="fullName" id="fullname" required="true" value="${user.fullName}">
                                </div>
                              
                                <div class="form-group">
                                    <label for="email-address">Email Address</label>
                                    <input type="email" class="form-control" name="email" id="email" readonly="true" value="${user.email}">
                                </div>
                                <!-- .form-group end -->
                                <div class="form-group">
                                    <label for="phone-number">Mobile Number</label>
                                    <input type="text" class="form-control" name="mobileNumber" id="mobilenumber" required="true" value="${user.mobileNumber}">
                                </div>
                                <!-- .form-group end -->
                                <div class="form-group">
                                    <label for="about-me">About Me</label>
                                    <textarea class="form-control" name="aboutMe" id="aboutme" rows="2" required="true">${user.aboutMe}</textarea>
                                </div>
                                <!-- .form-group end -->
                            </div>
