                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="manage-city.html" class="breadcrumb-link"> Reviews</a></li>
                                        ...
                                        <tbody>
		    								<c:forEach items="${feedbackList}" var="feedback" varStatus="count">
                								<tr>
									                ...
									                <td>
										                <a href="<%=context%>/admin/approveFeedback?feedbackId=${feedback.feedbackId}&fromPage=new-reviews">Approve</a> | 
										                <a href="<%=context%>/admin/unapproveFeedback?feedbackId=${feedback.feedbackId}&fromPage=new-reviews">Unapprove</a> | 
										                <a href="<%=context%>/admin/deleteFeedback?feedbackId=${feedback.feedbackId}&fromPage=new-reviews">Delete</a>
									                </td>
								                </tr>
							                </c:forEach>
                                        </tbody>
