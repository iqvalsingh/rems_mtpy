                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form  method="post" action="<%=context%>/admin/updateState">
                                        ...
                                        <p style="font-size:16px; color:red" align="center"></p>
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <select type="text" name="country" id="country" required="true" class="form-control">
		    										<c:forEach items="${countryList}" var="country" >
	                                                	<option value="${country.countryId}" ${country.countryId == state.country.countryId ? 'selected' : ''}>${country.countryName}</option>
	                                                </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="stateName" id="stateName" required="true"  class="form-control" value="${state.stateName}">
                                            </div>
                                        </div>
