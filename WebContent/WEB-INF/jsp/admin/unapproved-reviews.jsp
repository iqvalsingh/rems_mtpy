                                        ...
                                        <tbody>
		    								<c:forEach items="${feedbackList}" var="feedback" varStatus="count">
                								<tr>
									                ...
									                <td>
										                <a href="<%=context%>/admin/approveFeedback?feedbackId=${feedback.feedbackId}&fromPage=unapproved-reviews">Approve</a> | 
										                <a href="<%=context%>/admin/deleteFeedback?feedbackId=${feedback.feedbackId}&fromPage=unapproved-reviews">Delete</a>
									                </td>
								                </tr>
							                </c:forEach>
                                        </tbody>
