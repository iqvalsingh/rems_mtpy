                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
										    <c:forEach items="${agents}" var="agent" varStatus="count" >                                     
								                <tr>
									                <td>${count.index+1}</td>
									                <td>${agent.fullName}</td>
									                <td>${agent.mobileNumber}</td>
									                <td>${agent.creationDate}</td>
									                <td><a href="<%=context%>/admin/view-users-details.html?userId=${agent.userId}">View Details</a></td>
								                </tr>
								    		</c:forEach>
                                        </tbody>
